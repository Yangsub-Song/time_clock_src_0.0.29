...
private val dialogTimeout = 30.seconds

///////////////////////////////////////////////////////////////////////////
// RegisterFingerDialog.kt 복사한 코드
// - 메인 화면에 지문 등록 추가되면서 코드 그대로 복사함
///////////////////////////////////////////////////////////////////////////

/**
 * 지문 등록 event 초기화
 */
fun Pane.initRegisterFinger() {
 ...
 * 지문등록 버튼 view
 */
fun Pane.addFinger(root: View) {
    bottomButton("/main/BTN_AddFingerprint2.png") { button ->
        button.apply {
            addClass(Styles.bigButton)
            action {
                root.agreementDialog {
                    val controller = find(RegisterFingerController::class)
                    controller.retryCount = 1
